# Generated by Django 4.1.1 on 2022-09-07 17:15
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('created', models.DateTimeField(auto_now_add=True)),
                ('updated', models.DateTimeField(auto_now=True)),
                ('delivery_cost', models.IntegerField(verbose_name='delivery cost')),
                ('city', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='delivery_map', to='commerce.city')),
            ],
            options={
                'abstract': False,
            },
